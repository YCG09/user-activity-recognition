...
public class WindowDataToFeatureForWeka {
...
//			generateDataSet(658, "C:/Users/ycg3/Desktop/part-r-00000");
			...
			try (FileOutputStream fos = new FileOutputStream(new File("C:/Users/ycg3/Desktop/activity-train.arff"), false);
					OutputStreamWriter osw = new OutputStreamWriter(fos, "UTF-8");
					BufferedWriter bw = new BufferedWriter(osw);) {
				...
				String classInfo = "@attribute Class" + " " + "{SEDENTARY,INCAR,RUNNING,WALKING,INTRAIN,BIKING}";
