...
public class BalanceAndCrossValidationForDice {
...
//		}
	...
	public static void seperateDataSet(int num, String filepath, String target_path){
		...
		int Partial_Set_Num = dataSet.size() / WINDOW_LENGTH / 10 * WINDOW_LENGTH;
		ArrayList<String> list = new ArrayList<>();
		int index = 0;
		for(String d : dataSet){
			list.add(d);
			
			if(list.size() == Partial_Set_Num){
				try (FileOutputStream fos = new FileOutputStream(new File("C:/Users/ycg3/Desktop/regulation/" + target_path + "/partial_result_" + index), false);
		...
		for(int i = 0; i < 10; i++){
			...
			File input = new File("C:/Users/ycg3/Desktop/regulation/" + target_path + "/partial_result_" + i);
			try {
			...
			try (FileOutputStream fos = new FileOutputStream(new File("C:/Users/ycg3/Desktop/regulation/" + target_path + "/feature_result_" + i), false);
					OutputStreamWriter osw = new OutputStreamWriter(fos, "UTF-8");
					BufferedWriter bw = new BufferedWriter(osw);) {
				int line = 0;
...
//				}
	...
	public static void generateDataSet(String filepath, int fold){
		BufferedReader reader = null;
		HashSet<Integer> randomSet = new HashSet<>();
		randomSet.add(fold);
		randomSet.add((fold + 1) % 10);
		...
		for(int i : randomSet){
			File test = new File("C:/Users/ycg3/Desktop/regulation/" + filepath + "/feature_result_" + i);
		...
		try (FileOutputStream fos = new FileOutputStream(new File("C:/Users/ycg3/Desktop/regulation/testSet_" + fold + ".txt"), true);
				OutputStreamWriter osw = new OutputStreamWriter(fos, "UTF-8");
				BufferedWriter bw = new BufferedWriter(osw);) {
			int line = 0;
		...
		for(int i = 0; i < 10; i++){
			if(!randomSet.contains(i)){
				File train = new File("C:/Users/ycg3/Desktop/regulation/" + filepath + "/feature_result_" + i);
				try {
		...
		try (FileOutputStream fos = new FileOutputStream(new File("C:/Users/ycg3/Desktop/regulation/trainSet_" + fold + ".txt"), true);
				OutputStreamWriter osw = new OutputStreamWriter(fos, "UTF-8");
				BufferedWriter bw = new BufferedWriter(osw);) {
			int line = 0;
	...
	public static void main(String[] args) throws IOException {
		...
		seperateDataSet(232, "C:/Users/ycg3/Desktop/dataset/incar_1", "incar_1");
		seperateDataSet(50, "C:/Users/ycg3/Desktop/dataset/incar_2", "incar_2");
		seperateDataSet(75, "C:/Users/ycg3/Desktop/dataset/sedentary_1", "sedentary_1");
		seperateDataSet(79, "C:/Users/ycg3/Desktop/dataset/sedentary_2", "sedentary_2");
		seperateDataSet(41, "C:/Users/ycg3/Desktop/dataset/sedentary_3", "sedentary_3");
		seperateDataSet(193, "C:/Users/ycg3/Desktop/dataset/running_1", "running");		
		seperateDataSet(199, "C:/Users/ycg3/Desktop/dataset/intrain", "intrain");
		seperateDataSet(253, "C:/Users/ycg3/Desktop/dataset/biking_2017-03-29", "biking");		
		seperateDataSet(216, "C:/Users/ycg3/Desktop/dataset/walking_2017-03-29", "walking");
			
		
		for(int fold = 0; fold < 10; fold++){
			System.out.println("Fold " + fold + "---------------------------");
			generateDataSet("incar_1", fold);
			generateDataSet("incar_2", fold);
			generateDataSet("sedentary_1", fold);
			generateDataSet("sedentary_2", fold);
			generateDataSet("sedentary_3", fold);
			generateDataSet("running", fold);
			generateDataSet("walking", fold);
			generateDataSet("intrain", fold);
			generateDataSet("biking", fold);
			
			File file = new File("C:/Users/ycg3/Desktop/regulation/trainSet_" + fold + ".txt");
			BufferedReader reader = null;
			...
			File file_ = new File("C:/Users/ycg3/Desktop/regulation/testSet_" + fold + ".txt");
			...
			try (FileOutputStream fos = new FileOutputStream(new File("D:/Context_Awareness/Algorithm/RandomForest/data/fold_" + fold + "/activity-test.arff"), false);
					OutputStreamWriter osw = new OutputStreamWriter(fos, "UTF-8");
					BufferedWriter bw = new BufferedWriter(osw);) {
				bw.write("@relation MultiLabelData"); bw.newLine();
				bw.newLine();
